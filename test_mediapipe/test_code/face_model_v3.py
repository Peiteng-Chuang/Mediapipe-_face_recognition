...
def predict_img(img, model):
    ...
    # 繪製圖像和預測標籤
    return class_label,prob_distribution_str
...
while cap.isOpened():
    ...
    class_label,prob_distribution_str=predict_img(image, model)
    cv2.putText(frame, f'face type: {class_label}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2, cv2.LINE_AA)
    cv2.putText(frame, f'prob: {prob_distribution_str}', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2, cv2.LINE_AA)
    # 顯示結果影像
